    ...
    <div className={`modal`} onClick={onClose}>
      <div className={`modal-content`} data-aos={`zoom-in`} data-aos-duration="800">
        ...
        <div className="modal-buttons">
          ...
          <a href={`whatsapp://send?text=${name} ב${price} https://menu-patron.qbmedia.co.il`} data-action="share/whatsapp/share" rel="noreferrer" target="_blank" >
